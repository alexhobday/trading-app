...
var StockAnalysisService = class {
  static {
    __name(this, "StockAnalysisService");
  }
  ...
  async analyzeStock(symbol) {
    try {
      ...
      const historicalData = await this.stockService.getHistoricalData(symbol, 60);
  ...
  async getTopPicks(symbols = null) {
    ...
    try {
      ...
      for (let i = 0; i < Math.min(symbols.length, 5); i++) {
        ...
        if (i < 4) await new Promise((resolve) => setTimeout(resolve, 1e3));
      }
      const validAnalyses = analyses.filter((result) => result.status === "fulfilled").map((result) => result.value);
...
stocks.get("/analyze-html", async (c) => {
  ...
  try {
    ...
    const signalsHtml = analysis.signals.map((signal) => {
      const colorClass = signal.type === "bullish" ? "positive" : signal.type === "bearish" ? "negative" : "neutral";
      return `<div class="${colorClass}" style="margin: 5px 0; font-size: 0.9rem;">
        ${signal.message}
      </div>`;
    }).join("");
    const tipsHtml = analysis.tips.map((tip) => {
      const icon = tip.type === "buy" ? "\u{1F4C8}" : tip.type === "sell" ? "\u{1F4C9}" : tip.type === "warning" ? "\u26A0\uFE0F" : "\u2139\uFE0F";
      return `<div style="margin: 8px 0; padding: 8px; background: #f8f9fa; border-radius: 6px; font-size: 0.9rem;">
        ${icon} ${tip.message}
      </div>`;
    }).join("");
    const recColor = analysis.recommendation.action === "BUY" ? "positive" : analysis.recommendation.action === "SELL" ? "negative" : "neutral";
    return c.html(`
      <div style="margin-top: 20px;">
        <div class="position" style="flex-direction: column; align-items: stretch;">
          ...
          <div style="border-top: 1px solid #e1e5e9; padding-top: 15px; margin-bottom: 15px;">
            <h4 style="margin-bottom: 10px;">\u{1F4CA} Technical Analysis</h4>
          ...
          <div style="border-top: 1px solid #e1e5e9; padding-top: 15px; margin-bottom: 15px;">
            <h4 style="margin-bottom: 10px;">\u{1F3AF} Recommendation</h4>
          ...
          <div style="border-top: 1px solid #e1e5e9; padding-top: 15px; margin-bottom: 15px;">
            <h4 style="margin-bottom: 10px;">\u{1F4C8} Signals</h4>
            ${signalsHtml}
          </div>
          ` : ""}
          ...
          <div style="border-top: 1px solid #e1e5e9; padding-top: 15px;">
            <h4 style="margin-bottom: 10px;">\u{1F4A1} Tips</h4>
            ${tipsHtml}
          </div>
          ` : ""}
        </div>
...
function Layout({ title: title2, children }) {
  return /* @__PURE__ */ jsxDEV("html", { children: [
    ...
    /* @__PURE__ */ jsxDEV("body", { children: [
      /* @__PURE__ */ jsxDEV("div", { class: "app-layout", children: [
        /* @__PURE__ */ jsxDEV("nav", { class: "sidebar", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "sidebar-header", children: [
            /* @__PURE__ */ jsxDEV("h1", { children: "Micro Cap Trader" }),
            /* @__PURE__ */ jsxDEV("p", { children: "AI-Powered Trading Platform" })
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "sidebar-nav", children: [
            /* @__PURE__ */ jsxDEV("div", { class: "nav-section", children: [
              /* @__PURE__ */ jsxDEV("div", { class: "nav-section-title", children: "Portfolio" }),
              /* @__PURE__ */ jsxDEV("button", { class: "nav-item active", onclick: "showSection('dashboard')", children: [
                /* @__PURE__ */ jsxDEV("span", { class: "nav-item-icon", children: "\u{1F4CA}" }),
                "Dashboard"
              ] }),
              /* @__PURE__ */ jsxDEV("button", { class: "nav-item", onclick: "showSection('portfolio')", children: [
                /* @__PURE__ */ jsxDEV("span", { class: "nav-item-icon", children: "\u{1F4B0}" }),
                "Holdings"
              ] }),
              /* @__PURE__ */ jsxDEV("button", { class: "nav-item", onclick: "showSection('trading')", children: [
                /* @__PURE__ */ jsxDEV("span", { class: "nav-item-icon", children: "\u{1F504}" }),
                "Trading"
              ] })
            ] }),
            /* @__PURE__ */ jsxDEV("div", { class: "nav-section", children: [
              /* @__PURE__ */ jsxDEV("div", { class: "nav-section-title", children: "Research" }),
              /* @__PURE__ */ jsxDEV("button", { class: "nav-item", onclick: "showSection('analysis')", children: [
                /* @__PURE__ */ jsxDEV("span", { class: "nav-item-icon", children: "\u{1F4C8}" }),
                "Stock Analysis"
              ] }),
              /* @__PURE__ */ jsxDEV("button", { class: "nav-item", onclick: "showSection('search')", children: [
                /* @__PURE__ */ jsxDEV("span", { class: "nav-item-icon", children: "\u{1F50D}" }),
                "Stock Search"
              ] }),
              /* @__PURE__ */ jsxDEV("button", { class: "nav-item", onclick: "showSection('picks')", children: [
                /* @__PURE__ */ jsxDEV("span", { class: "nav-item-icon", children: "\u{1F31F}" }),
                "Top Picks"
              ] })
            ] }),
            /* @__PURE__ */ jsxDEV("div", { class: "nav-section", children: [
              /* @__PURE__ */ jsxDEV("div", { class: "nav-section-title", children: "Tools" }),
              /* @__PURE__ */ jsxDEV("button", { class: "nav-item", onclick: "showSection('quotes')", children: [
                /* @__PURE__ */ jsxDEV("span", { class: "nav-item-icon", children: "\u{1F4B9}" }),
                "Quick Quote"
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxDEV("main", { class: "main-content", children: [
          /* @__PURE__ */ jsxDEV("header", { class: "top-bar", children: [
            /* @__PURE__ */ jsxDEV("h1", { class: "page-title", id: "page-title", children: "Dashboard" }),
            /* @__PURE__ */ jsxDEV("div", { children: /* @__PURE__ */ jsxDEV("span", { style: "font-size: 0.875rem; color: #718096;", children: [
              "Last updated: ",
              /* @__PURE__ */ jsxDEV("span", { id: "last-updated" })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "content-area", children })
        ] })
      ] }),
...
function StockAnalysis() {
  return /* @__PURE__ */ jsxDEV("div", { class: "card", children: [
    /* @__PURE__ */ jsxDEV("h2", { children: "\u{1F9E0} AI-Powered Stock Analysis" }),
    /* @__PURE__ */ jsxDEV("p", { style: "margin-bottom: 20px; color: #666; font-size: 0.9rem;", children: "Get comprehensive analysis of small & micro-cap stocks with AI-powered insights, technical indicators, and trading recommendations." }),
    /* @__PURE__ */ jsxDEV("form", { "hx-get": "/api/stocks/analyze-html", "hx-target": "#analysis-result", "hx-trigger": "submit", children: [
      /* @__PURE__ */ jsxDEV(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxDEV("button", { type: "submit", class: "btn", children: "\u{1F50D} Analyze with AI" })
    ] }),
    /* @__PURE__ */ jsxDEV("div", { id: "analysis-result" })
  ] });
}
__name(StockAnalysis, "StockAnalysis");
function TopPicks() {
  return /* @__PURE__ */ jsxDEV("div", { class: "card", children: [
    /* @__PURE__ */ jsxDEV("h2", { children: "\u{1F31F} Top Small Cap Picks" }),
    /* @__PURE__ */ jsxDEV("p", { style: "margin-bottom: 20px; color: #666;", children: "AI-powered analysis of trending small & micro-cap stocks with buy/sell recommendations" }),
    /* @__PURE__ */ jsxDEV(
      "button",
      {
        ...
        "hx-trigger": "click",
        class: "btn",
        children: "Get Latest Picks"
      }
    ),
    /* @__PURE__ */ jsxDEV("div", { id: "top-picks-result" }),
    /* @__PURE__ */ jsxDEV("script", { dangerouslySetInnerHTML: { __html: `
        document.addEventListener('DOMContentLoaded', function() {
                  ...
                  const html = \`
                    <div style="margin-top: 20px;">
                      ...
                      \${response.picks.map((pick, index) => {
                        ...
                        const badge = pick.recommendation.action === 'BUY' ? '\u{1F680}' :
                                     pick.recommendation.action === 'SELL' ? '\u{1F4C9}' : '\u23F8\uFE0F';
...
function HomePage(portfolioData) {
  return /* @__PURE__ */ jsxDEV(Layout, { title: "Micro Cap Trader", children: [
    ...
    /* @__PURE__ */ jsxDEV("div", { id: "dashboard-section", class: "content-section", children: [
      /* @__PURE__ */ jsxDEV("div", { class: "stats-grid", children: [
        /* @__PURE__ */ jsxDEV("div", { class: "stat-card", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "stat-value", children: [
            "$",
            portfolioData.cash || "0.00"
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "stat-label", children: "Cash Available" })
        ] }),
        /* @__PURE__ */ jsxDEV("div", { class: "stat-card", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "stat-value", children: [
            "$",
            portfolioData.totalPositionValue || "0.00"
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "stat-label", children: "Holdings Value" })
        ] }),
        /* @__PURE__ */ jsxDEV("div", { class: "stat-card", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "stat-value", children: [
            "$",
          ...
          /* @__PURE__ */ jsxDEV("div", { class: "stat-label", children: "Total Portfolio" })
        ] }),
        /* @__PURE__ */ jsxDEV("div", { class: "stat-card", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "stat-value", children: Object.keys(portfolioData.positions || {}).length }),
          /* @__PURE__ */ jsxDEV("div", { class: "stat-label", children: "Active Positions" })
        ] })
      ] }),
      /* @__PURE__ */ jsxDEV("div", { class: "dashboard-grid-wide", children: /* @__PURE__ */ jsxDEV(TopPicks, {}) })
    ] }),
    /* @__PURE__ */ jsxDEV("div", { id: "portfolio-section", class: "content-section", style: "display: none;", children: [
      /* @__PURE__ */ jsxDEV(PortfolioSummary, { ...portfolioData }),
      /* @__PURE__ */ jsxDEV(CashForm, {})
    ] }),
    /* @__PURE__ */ jsxDEV("div", { id: "trading-section", class: "content-section", style: "display: none;", children: /* @__PURE__ */ jsxDEV("div", { class: "dashboard-grid", children: [
      /* @__PURE__ */ jsxDEV(BuyForm, {}),
      /* @__PURE__ */ jsxDEV(SellForm, {})
    ] }) }),
    /* @__PURE__ */ jsxDEV("div", { id: "analysis-section", class: "content-section", style: "display: none;", children: /* @__PURE__ */ jsxDEV(StockAnalysis, {}) }),
    /* @__PURE__ */ jsxDEV("div", { id: "search-section", class: "content-section", style: "display: none;", children: /* @__PURE__ */ jsxDEV(StockSearch, {}) }),
    /* @__PURE__ */ jsxDEV("div", { id: "picks-section", class: "content-section", style: "display: none;", children: /* @__PURE__ */ jsxDEV("div", { class: "card", children: [
      /* @__PURE__ */ jsxDEV("h2", { children: "\u{1F31F} Top Small Cap Picks" }),
      /* @__PURE__ */ jsxDEV("p", { style: "margin-bottom: 20px; color: #666;", children: "AI-powered analysis of trending small & micro-cap stocks with buy/sell recommendations" }),
      /* @__PURE__ */ jsxDEV("p", { style: "color: #666; font-style: italic;", children: "Top picks are automatically loaded on the Dashboard. Click the Dashboard tab to view the latest AI-powered recommendations." }),
      /* @__PURE__ */ jsxDEV("button", { onclick: "showSection('dashboard')", class: "btn", style: "margin-top: 16px;", children: "View Dashboard" })
    ] }) }),
    /* @__PURE__ */ jsxDEV("div", { id: "quotes-section", class: "content-section", style: "display: none;", children: /* @__PURE__ */ jsxDEV(StockQuote, {}) })
  ] });
}
...
// .wrangler/tmp/bundle-oUuSm5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-oUuSm5/middleware-loader.entry.ts
